...
<h2> Inscription au forum </h2>
	...
	<form method="post" action="Traitement_TP_INFORMATIQUE.php" enctype="multipart/form-data">
	    ...
	    <input type = "text" name = "prenom" id = "prenom" placeholder = "Prénom" size = "45" required /> </br>

	    <label for = "pseudo"> Votre nom : </label> </br>
	    <input type = "text" name = "nom" id = "nom" placeholder = "Nom" size = "45" required /> </br>

	    <label for = "mail"> Votre e-mail : </label> </br>
	    <input type = "email" name = "mail" id = "mail" placeholder = "E-mail" size = "45" required /> </br> 

		<label for = "password"> Votre mot de passe : </label> </br>
	    <input type = "password" name = "password" id = "password" placeholder = "Mot de passe" size = "45" required /></br>
